...
const getRandomWeightStock = (minKg: number, maxKg: number) =>
  Math.floor((Math.random() * (maxKg - minKg) + minKg) * 1000);
    ...
    const vendorGroups = [
      {
        ...
        cats: ["بقالة", "ألبان", "منظفات", "مشروبات"],
      },
    ...
    const productMap = [
      {
        ...
        measureType: MeasurementType.UNIT,
        vendors: [SEED_DATA.VENDORS.SUPER_MARKET_1, SEED_DATA.VENDORS.SUPER_MARKET_2, VENDOR_IDS.SANAQREH],
        vCat: "ألبان",
        items: ["حليب جهينة", "زبادي المراعي", "جبنة بيضاء", "قشطة", "زبدة", "لبن رايب"],
      },
      {
      ...
      },
      {
        ...
        vendors: [SEED_DATA.VENDORS.SUPER_MARKET_1, SEED_DATA.VENDORS.SUPER_MARKET_2, VENDOR_IDS.SANAQREH],
        vCat: "مشروبات",
        items: ["مياه سيوة", "عصير جهينة برتقال", "بيبسي", "شاي ليبتون", "نسكافيه", "ريد بول"],
      },
      {
        ...
        vendors: [SEED_DATA.VENDORS.SUPER_MARKET_1, SEED_DATA.VENDORS.SUPER_MARKET_2, VENDOR_IDS.SANAQREH],
        vCat: "منظفات",
        items: ["تايد أوتوماتيك", "فيري ليمون", "ديتول أرضيات", "كلور", "مناديل مطبخ", "معطر جو"],
      },
      {
        globalCat: SEED_DATA.CATEGORIES.PHARMACY_OTC,
        measureType: MeasurementType.UNIT,
        vendors: [SEED_DATA.VENDORS.PHARMACY, VENDOR_IDS.AHMED_YEHIA, VENDOR_IDS.SABAWI],
        vCat: "أدوية",
        items: ["بنادول اكسترا", "بروفين", "كتافلام", "كومتركس", "فيتامين سي فوار", "أسبيرين"],
      },

      {
        globalCat: SEED_DATA.CATEGORIES.MEAT,
        measureType: MeasurementType.WEIGHT,
        vendors: [SEED_DATA.VENDORS.BUTCHER, VENDOR_IDS.ABDULLAH_BUTCHER],
        vCat: "لحوم طازجة",
        items: ["لحم بقري", "لحم ضاني", "كبدة بقري", "مفروم بقري", "سجق بلدي", "كفتة حياتي"],
      },
      {
        globalCat: SEED_DATA.CATEGORIES.POULTRY,
        measureType: MeasurementType.WEIGHT,
        vendors: [SEED_DATA.VENDORS.POULTRY, VENDOR_IDS.BEHEIRY_POULTRY],
        vCat: "دواجن",
        items: ["فراخ بيضاء", "فراخ بلدي", "بانية", "شيش طاووق", "أوراك فراخ", "كبد وقوانص"],
      },
      {
        globalCat: SEED_DATA.CATEGORIES.FISH,
        measureType: MeasurementType.WEIGHT,
        vendors: [
          SEED_DATA.VENDORS.FISH,
          VENDOR_IDS.GHANEM_FISH,
          VENDOR_IDS.MUTAWAKKIL_FISH,
          VENDOR_IDS.ABU_YOUSSEF_FISH,
        ],
        vCat: "أسماك",
        items: ["سمك بلطي", "سمك بوري", "جمبري", "سبيط", "سمك ماكريل", "سمك فيليه"],
      },

      {
        globalCat: ROASTERY_CAT,
        measureType: MeasurementType.WEIGHT,
        vendors: [VENDOR_IDS.BONDOQA, VENDOR_IDS.ASHRI, VENDOR_IDS.LOZINA],
        vCat: "لب وبن",
        items: ["لب سوبر", "لب عباد", "فول سوداني", "بن فاتح", "بن محوج", "مكسرات مشكلة"],
      },
      {
        globalCat: SEED_DATA.CATEGORIES.BAKERY,
        measureType: MeasurementType.UNIT,
        vendors: [SEED_DATA.VENDORS.BAKERY, VENDOR_IDS.AL_BARAKA_BAKERY],
        vCat: "خبز طازج",
        items: ["عيش بلدي", "عيش فينو", "بقسماط", "قرص سادة", "باتيه جبنة", "توست أبيض"],
      },
      {
        globalCat: SEED_DATA.CATEGORIES.BAKERY,
        measureType: MeasurementType.UNIT,
        vendors: [VENDOR_IDS.ABU_OMAR, VENDOR_IDS.RAWAN],
        vCat: "حلويات شرقية",
        items: ["بسبوسة سادة", "كنافة بالكريمة", "بقلاوة مكسرات", "تورتة شوكولاتة", "بلح الشام"],
      },
      {
        globalCat: STATIONERY_CAT,
        measureType: MeasurementType.UNIT,
        vendors: [VENDOR_IDS.SHADY_LIBRARY],
        vCat: "أدوات مكتبية",
        items: ["كشكول سلك", "قلم جاف أزرق", "مقلمة", "ألوان خشب", "براية", "أستيكة"],
      },

      {
        globalCat: VEG_FRUIT_CAT,
        measureType: MeasurementType.WEIGHT,
        vendors: [VENDOR_IDS.AWLAD_RAGAB, VENDOR_IDS.MAZAARE_AL_KHEIR],
        vCat: "خضروات",
        items: ["طماطم", "خيار", "بطاطس", "بصل", "فلفل رومي", "باذنجان"],
      },
      {
        globalCat: VEG_FRUIT_CAT,
        measureType: MeasurementType.WEIGHT,
        vendors: [VENDOR_IDS.AWLAD_RAGAB, VENDOR_IDS.MAZAARE_AL_KHEIR],
        vCat: "فاكهة",
        items: ["تفاح أحمر", "موز", "برتقال بلدي", "فراولة", "جوافة"],
      },
    ];
        ...
        for (const name of section.items) {
          ...
          await connection.execute(
            ...
            [
              ...
              section.globalCat,
              section.measureType,
              section.measureType === MeasurementType.WEIGHT ? WeightUnit.KG : null,
            ],
          );
