CREATE TABLE customer_orders (
  ...
  status ENUM('PENDING_VENDOR_CONFIRMATION','PREPARING','WAITING_CUSTOMER_DECISION','READY','PICKED_UP', 'IN_DELIVERY','COMPLETED','CANCELLED') DEFAULT 'PENDING_VENDOR_CONFIRMATION',
...
CREATE TABLE vendor_orders (
  ...
  status ENUM('PENDING', 'PREPARING', 'PROPOSAL_SENT', 'CONFIRMED', 'PICKED_UP', 'ON_THE_WAY', 'DELIVERED', 'CANCELLED') DEFAULT 'PENDING',
  subtotal DECIMAL(10, 2) NOT NULL,
  commission_amount DECIMAL(10, 2) DEFAULT 0,
  total_amount DECIMAL(10, 2) NOT NULL,
...
CREATE TABLE vendor_order_items (
  ...
  quantity INT NULL,
  requested_weight DECIMAL(10, 3) NULL,
...
CREATE TABLE order_item_proposals (
  ...
  proposed_weight DECIMAL(10, 3) NULL,
  requested_weight_grams INT NULL,
